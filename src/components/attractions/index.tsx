...
const Attractions: React.FC = () => {
  const displayedAttractions = attractionsData.slice(0, 3);
    ...
    <Box component="section" py={{ xs: 6, md: 12 }}>
      <Container maxWidth="xl">
        ...
        <Grid container spacing={3}>
          {displayedAttractions.map((attraction: Attraction) => (
        ...
        {attractionsData.length > 3 && (
          <Box sx={{ display: "flex", justifyContent: "end", mt: 3 }}>
            <Button component={Link} to="/attractions" size="large">
              See All &nbsp;{" "}
              <span
